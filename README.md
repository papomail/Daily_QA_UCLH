...
The script will automatically select the [required files](dqa.md#labeling-the-acquisition) and process them. Once finished, a summary of the results will be displayed in your browser.   
